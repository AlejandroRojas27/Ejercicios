...
public class Ejercicio_10_9_TheCourseClass {
...
class Course {
    ...
    public void dropStudent(String student) {
        ...
        String[] temp = removeElement(students, index);
    ...
    public String[] getStudents() {
        String[] copyOf = new String[numberOfStudents];

        System.arraycopy(students, 0, copyOf, 0, numberOfStudents);
